...
public class Main {
    ...
    static String member[][] = {
            ...
            {"Sucipto","bersyukur", "user"},
            {"Ahmad","alhamdulillah", "user"},
            {"Siti","bersyukur", "user"},
            {"Sugeng","radiator", "user"},
            {"Slamet", "soundsistem","user"},
                ...
                if (calculate < 0){
                    ...
                    switch (section){
                        ...
                        default:
                            ...
                            System.out.println("|");
                            if (payTotal >= 100000 && payTotal <= 500000){
                                diskon = payTotal * 0.1;
                                pay = payTotal - diskon;
                                System.out.printf("|");
                                ...
                                System.out.printf("%-2s","|");
                                System.out.printf("%-10s", diskon);
                                System.out.println("Total Pay = " + pay);
                            } else if (payTotal > 500000) {
                                diskon = payTotal * 0.2;
                                pay = payTotal - diskon;
                                System.out.printf("|");
                                System.out.printf("Discount");
                                System.out.printf("%-2s","|");
                                System.out.printf("%-7s","20%");
                                System.out.printf("%-2s","|");
                                System.out.printf("%-10s", diskon);
                                System.out.println("Total Pay = " + pay);
                            }else {
